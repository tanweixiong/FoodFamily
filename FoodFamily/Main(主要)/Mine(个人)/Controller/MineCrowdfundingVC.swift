...
class MineCrowdfundingVC: UIViewController,SGPageTitleViewDelegate, SGPageContentViewDelegare {
    ...
    fileprivate let titleArr:NSArray = ["全部众筹", "成功","失败"]
    ...
    override func viewDidLoad() {
        ...
        let mineAllCrowdfundingVC = MineAllCrowdfundingVC()
        let mineFinishCrowdfundingVC = MineFinishCrowdfundingVC()
        let mineFailureCrowdfundingVC = MineFailureCrowdfundingVC()
        let childVC = [mineAllCrowdfundingVC,mineFinishCrowdfundingVC,mineFailureCrowdfundingVC]
