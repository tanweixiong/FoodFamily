//
//  MineFinishCrowdfundingVC.swift
//  FoodFamily
//
...
class MineFinishCrowdfundingVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    
    fileprivate let mineCrowdfundingCell = "MineCrowdfundingCell"
    
    struct MineFinishCrowdfundingUX {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return  MineFinishCrowdfundingUX.cellHeight
    }
    
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        return MineFinishCrowdfundingUX.sectionLineHeight
    }
    
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let view = UIView.init(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH, height: MineFinishCrowdfundingUX.sectionLineHeight))
